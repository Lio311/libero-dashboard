...
export const VelourInfluencersPage = () => {
    ...
    } = useInfluencerPage({ influencerTable: 'velour_influencers', couponTable: 'velour_coupons', currentDate });
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold text-slate-900">משפיענים וולור</h1>
                <MonthNavigator currentDate={currentDate} onDateChange={setCurrentDate} />
            </div>
            <Table title="משפיענים וולור" data={influencers} onSave={handleSaveInfluencers} onAdd={handleAddInfluencer} onDelete={handleDeleteInfluencer} columns={influencerColumns} />
            <Table
