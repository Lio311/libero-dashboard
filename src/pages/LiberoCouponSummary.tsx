...
export const LiberoCouponSummary = () => {
    ...
    const fetchData = async () => {
        ...
        setError(null);
        try {
            // In development, the API route is served by Vercel Dev or Vite proxy at /api/libero-coupons
            const response = await fetch(`/api/libero-coupons?month=${month}`);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900">סיכום קופונים ליברו</h1>
