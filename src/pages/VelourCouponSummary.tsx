...
export const VelourCouponSummary = () => {
    ...
    const fetchData = async () => {
        ...
        setError(null);
        try {
            const response = await fetch(`/api/velour-coupons?month=${month}`);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900">סיכום קופונים וולור</h1>
